        ...
        {DAYS_OF_WEEK.map((day) => {
          ...
          return (
            <div key={day.index} className="space-y-2">
              ...
              {/* Time inputs ou Closed - abaixo do toggle */}
              {isDayActive ? (
                <div className="pl-6 space-y-2 sm:space-y-0 sm:flex sm:items-center sm:gap-4">
                  <div className="flex items-center gap-2">
                    <span className="text-sm min-w-[40px]">From</span>
                    <TimeInput
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm min-w-[40px]">To</span>
                    <TimeInput
